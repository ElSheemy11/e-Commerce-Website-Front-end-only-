...
Product Catalog: Displays a variety of products with their images, names, and prices.
Shopping Cart: Allows users to add products to the cart, view cart contents, and adjust quantities.
Interactive User Interface: Using JavaScript, the app supports interactions like adding/removing items from the cart and updating the total price.
...
CSS: Used to style and layout the components and make the website responsive.
...
Open the project folder and open index.html in your browser to view the application.

Contributing
Feel free to fork this repository and submit pull requests if you have improvements or new features in mind. Contributions are always welcome!
